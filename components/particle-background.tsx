  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      particlesRef.current.forEach((particle, index) => {
        ...
        // Pulsing opacity
        const pulsingOpacity = particle.opacity * (0.7 + 0.3 * Math.sin(timeRef.current * particle.pulseSpeed + particle.pulsePhase));
      ...
      // Draw floating orbs (large decorative elements)
      const orbPositions = [
